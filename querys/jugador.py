...
def convertir_csv_a_sql_jugador():
    ...
    for i in df.index:
        ...
        VALUES (
            ...
            {'NULL' if df['PrimerNombre'][i] is None else f"'{df['PrimerNombre'][i]}'"},
            {'NULL' if df['SegundoNombre'][i] is None else f"'{df['SegundoNombre'][i]}'"},
            {'NULL' if df['PrimerApellido'][i] is None else f"'{df['PrimerApellido'][i]}'"},
            {'NULL' if df['SegundoApellido'][i] is None else f"'{df['SegundoApellido'][i]}'"},
